...
class ArticleCat(models.Model):
    parent = models.ForeignKey('ArticleCat', null=True, blank=True, on_delete=models.CASCADE,
...
class Article(models.Model):
    ...
    is_active = models.BooleanField(default=True, verbose_name='فعال / غیرفعال')
    selected_categories = models.ManyToManyField(ArticleCat, verbose_name='دسته بندی ها')

# Generated by Django 4.1.7 on 2023-06-03 13:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='فعال / غیرفعال')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='article_module.articlecat', verbose_name='دسته بندی والد')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='article_module.articlecat', verbose_name='دسته بندی ها'),
        ),
    ]
